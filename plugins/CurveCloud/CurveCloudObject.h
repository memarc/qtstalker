...
#ifndef PLUGIN_CURVE_CLOUD_OBJECT_HPP
#define PLUGIN_CURVE_CLOUD_OBJECT_HPP
...
class CurveCloudObject : public Object
{
  Q_OBJECT

  public:
    CurveCloudObject (QString profile, QString name);
    ~CurveCloudObject ();
    void clear ();
