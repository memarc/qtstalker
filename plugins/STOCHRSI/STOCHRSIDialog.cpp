...
STOCHRSIDialog::STOCHRSIDialog (QHash<QString, void *> objects, QString name) : Dialog (0, name)
{
  QStringList tl;
  QDir dir(QDir::homePath());
  tl << dir.absolutePath() << QString("OTA") << QString("STOCHRSI") << QString("settings") << QString("dialog");
...
void
STOCHRSIDialog::createTab (QHash<QString, void *> l)
{
...
void
STOCHRSIDialog::setSettings (QString i, QString ik, int p)
{
  if (_input)
  {
...
void
STOCHRSIDialog::settings (QString &i, QString &ik, int &p)
{
  if (_input)
  {
