...
CMODialog::CMODialog (QHash<QString, void *> objects, QString name) : Dialog (0, name)
{
  QStringList tl;
  QDir dir(QDir::homePath());
  tl << dir.absolutePath() << QString("OTA") << QString("CMO") << QString("settings") << QString("dialog");
...
void
CMODialog::createTab (QHash<QString, void *> l)
{
...
void
CMODialog::setSettings (QString i, QString ik, int p)
{
...
void
CMODialog::settings (QString &i, QString &ik, int &p)
{
