...
MarkerRetracement::MarkerRetracement ()
{
...
int
MarkerRetracement::command (PluginCommand *pc)
{
  int rc = 0;
  ...
  {
    case 0: // type
      pc->type = QString("marker");
      rc = 1;
      break;
    case 1: // object
      pc->object = new MarkerRetracementObject(pc->profile, pc->name);
      rc = 1;
      break;
    default:
      break;
