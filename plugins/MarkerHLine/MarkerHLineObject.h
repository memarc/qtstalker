...
#ifndef PLUGIN_MARKER_HLINE_OBJECT_HPP
#define PLUGIN_MARKER_HLINE_OBJECT_HPP
...
class MarkerHLineObject : public Object
{
  Q_OBJECT
  ...
  public:
    ...
    MarkerHLineObject (QString profile, QString name);
    ~MarkerHLineObject ();
    void clear ();
