...
#ifndef PLUGIN_MARKER_VLINE_OBJECT_HPP
#define PLUGIN_MARKER_VLINE_OBJECT_HPP
...
class MarkerVLineObject : public Object
{
  Q_OBJECT
  ...
  public:
    ...
    MarkerVLineObject (QString profile, QString name);
    ~MarkerVLineObject ();
    void clear ();
