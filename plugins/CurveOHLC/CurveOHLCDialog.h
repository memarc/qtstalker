...
#ifndef PLUGIN_CURVE_OHLC_DIALOG_HPP
#define PLUGIN_CURVE_OHLC_DIALOG_HPP
...
class CurveOHLCDialog : public Dialog
{
  Q_OBJECT
  
  public:
    CurveOHLCDialog (QHash<QString, void *>, QString name);
    ~CurveOHLCDialog ();
