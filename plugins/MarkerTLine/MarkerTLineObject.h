...
#ifndef PLUGIN_MARKER_TLINE_OBJECT_HPP
#define PLUGIN_MARKER_TLINE_OBJECT_HPP
...
class MarkerTLineObject : public Object
{
  Q_OBJECT
  ...
  public:
    ...
    MarkerTLineObject (QString profile, QString name);
    ~MarkerTLineObject ();
    void clear ();
