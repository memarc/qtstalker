...
CMOObject::CMOObject (QString profile, QString name)
{
  TA_RetCode rc = TA_Initialize();
  if (rc != TA_SUCCESS)
    qDebug() << "CMOObject::CMOObject: error on TA_Initialize";
...
int
CMOObject::message (ObjectCommand *oc)
{
  int rc = 0;
...
int
CMOObject::update (ObjectCommand *oc)
{
  clear();
  ...
  if (! io)
  {
    qDebug() << "CMOObject::update: invalid input" << _inputObject;
    return 0;
  }
  ...
  if (! io->message(&toc))
  {
    qDebug() << "CMOObject::update: message error" << io->plugin() << toc.command();
    return 0;
  }
  ...
  if (! ibars)
  {
    qDebug() << "CMOObject::update: invalid input bars" << _inputKey;
    return 0;
  }
  ...
  if (rc != TA_SUCCESS)
  {
    qDebug() << "CMOObject::update: TA-Lib error" << rc;
    return 0;
  }
...
int
CMOObject::dialog (ObjectCommand *oc)
{
  CMODialog *dialog = new CMODialog(oc->getObjects(), _name);
...
void
CMOObject::dialogDone (void *dialog)
{
  CMODialog *d = (CMODialog *) dialog;
...
int
CMOObject::outputKeys (ObjectCommand *oc)
{
  QStringList keys;
  keys << _outputKey;
...
int
CMOObject::output (ObjectCommand *oc)
{
  outputKeys(oc);
...
int
CMOObject::load (ObjectCommand *oc)
{
  QSettings *settings = (QSettings *) oc->getObject(QString("QSettings"));
  if (! settings)
  {
    qDebug() << "CMOObject::load: invalid QSettings";
    return 0;
  }
...
int
CMOObject::save (ObjectCommand *oc)
{
  QSettings *settings = (QSettings *) oc->getObject(QString("QSettings"));
  if (! settings)
  {
    qDebug() << "CMOObject::save: invalid QSettings";
    return 0;
  }
