...
class AROONDialog : public Dialog
{
  ...
  public:
    AROONDialog (QHash<QString, void *> objects, QString name);
    ~AROONDialog ();
    void createTab (QHash<QString, void *>);
    void setSettings(QString i, QString hk, QString lk, int p);
    void settings(QString &i, QString &hk, QString &lk, int &p);
