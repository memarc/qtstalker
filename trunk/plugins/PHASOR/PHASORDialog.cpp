...
PHASORDialog::PHASORDialog (QHash<QString, void *> objects, QString name) : Dialog (0, name)
{
  QStringList tl;
...
void
PHASORDialog::createTab (QHash<QString, void *> l)
{
