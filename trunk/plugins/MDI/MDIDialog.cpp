...
MDIDialog::MDIDialog (QHash<QString, void *> objects, QString name) : Dialog (0, name)
{
  QStringList tl;
  QDir dir(QDir::homePath());
  tl << dir.absolutePath() << QString("OTA") << QString("MDI") << QString("settings") << QString("dialog");
...
void
MDIDialog::createTab (QHash<QString, void *> l)
{
...
void
MDIDialog::setSettings (QString i, QString hk, QString lk, QString ck, int p)
{
  if (_input)
  {
...
void
MDIDialog::settings (QString &i, QString &hk, QString &lk, QString &ck, int &p)
{
  if (_input)
  {
