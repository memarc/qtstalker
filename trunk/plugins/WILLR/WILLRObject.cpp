...
WILLRObject::WILLRObject (QString profile, QString name)
{
  TA_RetCode rc = TA_Initialize();
  if (rc != TA_SUCCESS)
    qDebug() << "WILLRObject::WILLRObject: error on TA_Initialize";
  
  _profile = profile;
  _name = name;
  _plugin = QString("WILLR");
...
int
WILLRObject::message (ObjectCommand *oc)
{
  int rc = 0;
...
int
WILLRObject::update (ObjectCommand *oc)
{
  clear();
  ...
  if (! io)
  {
    qDebug() << "WILLRObject::update: invalid input" << _inputObject;
    return 0;
  }
  ...
  if (! io->message(&toc))
  {
    qDebug() << "WILLRObject::update: message error" << io->plugin() << toc.command();
    return 0;
  }
  ...
  if (! hbars)
  {
    qDebug() << "ADXObject::update: invalid high bars" << _highKey;
    return 0;
  }
  ...
  if (! lbars)
  {
    qDebug() << "ADXObject::update: invalid low bars" << _lowKey;
    return 0;
  }
  ...
  if (! cbars)
  {
    qDebug() << "ADXObject::update: invalid close bars" << _closeKey;
    return 0;
  }
  ...
  if (rc != TA_SUCCESS)
  {
    qDebug() << "WILLRObject::update: TA-Lib error" << rc;
    return 0;
  }
...
int
WILLRObject::dialog (ObjectCommand *oc)
{
  WILLRDialog *dialog = new WILLRDialog(oc->getObjects(), _name);
...
void
WILLRObject::dialogDone (void *dialog)
{
  WILLRDialog *d = (WILLRDialog *) dialog;
...
int
WILLRObject::outputKeys (ObjectCommand *oc)
{
  QStringList keys;
  keys << _outputKey;
...
int
WILLRObject::output (ObjectCommand *oc)
{
  outputKeys(oc);
...
int
WILLRObject::load (ObjectCommand *oc)
{
  QSettings *settings = (QSettings *) oc->getObject(QString("QSettings"));
  if (! settings)
  {
    qDebug() << "WILLRObject::load: invalid QSettings";
    return 0;
  }
...
int
WILLRObject::save (ObjectCommand *oc)
{
  QSettings *settings = (QSettings *) oc->getObject(QString("QSettings"));
  if (! settings)
  {
    qDebug() << "WILLRObject::save: invalid QSettings";
    return 0;
  }
