...
ADXObject::ADXObject (QString profile, QString name)
{
  TA_RetCode rc = TA_Initialize();
  if (rc != TA_SUCCESS)
    qDebug() << "ADXObject::ADXObject: error on TA_Initialize";
...
int
ADXObject::message (ObjectCommand *oc)
{
  int rc = 0;
...
int
ADXObject::update (ObjectCommand *oc)
{
  clear();
  ...
  if (! io)
  {
    qDebug() << "ADXObject::update: invalid input" << _inputObject;
    return 0;
  }
  ...
  if (! io->message(&toc))
  {
    qDebug() << "ADXObject::update: message error" << io->plugin() << toc.command();
    return 0;
  }
  ...
  if (rc != TA_SUCCESS)
  {
    qDebug() << "ADXObject::update: TA-Lib error" << rc;
    return 0;
  }
...
int
ADXObject::dialog (ObjectCommand *oc)
{
  ADXDialog *dialog = new ADXDialog(oc->getObjects(), _name);
...
void
ADXObject::dialogDone (void *dialog)
{
  ADXDialog *d = (ADXDialog *) dialog;
...
int
ADXObject::outputKeys (ObjectCommand *oc)
{
  QStringList keys;
  keys << _outputKey;
...
int
ADXObject::output (ObjectCommand *oc)
{
  outputKeys(oc);
...
int
ADXObject::load (ObjectCommand *oc)
{
  QSettings *settings = (QSettings *) oc->getObject(QString("QSettings"));
  if (! settings)
  {
    qDebug() << "ADXObject::load: invalid QSettings";
    return 0;
  }
...
int
ADXObject::save (ObjectCommand *oc)
{
  QSettings *settings = (QSettings *) oc->getObject(QString("QSettings"));
  if (! settings)
  {
    qDebug() << "ADXObject::save: invalid QSettings";
    return 0;
  }
