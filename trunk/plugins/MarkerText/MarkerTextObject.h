...
#ifndef PLUGIN_MARKER_TEXT_OBJECT_HPP
#define PLUGIN_MARKER_TEXT_OBJECT_HPP
...
class MarkerTextObject : public Object
{
  Q_OBJECT
  ...
  public:
    ...
    MarkerTextObject (QString profile, QString name);
    ~MarkerTextObject ();
    void clear ();
