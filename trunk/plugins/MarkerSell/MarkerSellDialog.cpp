...
void
MarkerSellDialog::setSettings (QColor color, QDateTime date, double price, QString po)
{
...
void
MarkerSellDialog::settings (QColor &color, QDateTime &date, double &price, QString &po)
{
  color = _color->color();
  date = _date->dateTime();
  price = _price->value();
