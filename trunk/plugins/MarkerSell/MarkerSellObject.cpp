...
MarkerSellObject::MarkerSellObject (QString profile, QString name)
{
  _profile = profile;
  _name = name;
  _plugin = QString("MarkerSell");
...
MarkerSellObject::~MarkerSellObject ()
{
  save();
}

int
MarkerSellObject::message (ObjectCommand *oc)
{
  int rc = 0;
...
int
MarkerSellObject::draw (ObjectCommand *oc)
{
  // get painter
  QString key("painter");
  ...
  if (! p)
  {
    qDebug() << "MarkerSellObject::draw: invalid" << key;
    return 0;
  }
  ...
  if (_index == -1)
  {
    ...
    if (! plot->message(&toc))
    {
      qDebug() << "MarkerSellObject::draw: object message error" << toc.command();
      return 0;
    }
...
int
MarkerSellObject::info (ObjectCommand *oc)
{
  QString key("event");
  QMouseEvent *event = (QMouseEvent *) oc->getObject(key);
  if (! event)
  {
    qDebug() << "MarkerSellObject::info: invalid" << key;
    return 0;
  }
  ...
  Data info;
  info.insert(tr("Item"), QVariant(tr("Sell")));
...
int
MarkerSellObject::highLowRange (ObjectCommand *oc)
{
  // get plot
  QString key("plot");
  Object *plot = (Object *) oc->getObject(key);
  if (! plot)
  {
    qDebug() << "MarkerSellObject::highLowRange: invalid" << key;
    return 0;
  }
  ...
  if (! plot->message(&toc))
  {
    qDebug() << "MarkerSellObject::highLowRange: object message error" << toc.command();
    return 0;
  }
...
int
MarkerSellObject::mouseMove (ObjectCommand *oc)
{
  // mouse event
  QString key("event");
  QMouseEvent *event = (QMouseEvent *) oc->getObject(key);
  if (! event)
  {
    qDebug() << "MarkerSellObject::mouseMove: invalid" << key;
    return 0;
  }
...
int
MarkerSellObject::mousePress (ObjectCommand *oc)
{
  if (_readOnly)
    return 0;
  ...
  if (! event)
  {
    qDebug() << "MarkerSellObject::mousePress: invalid" << key;
    return 0;
  }
...
int
MarkerSellObject::create (ObjectCommand *)
{
  _status = _MOVING;
  _selected = TRUE;
  return 1;
...
int
MarkerSellObject::isSelected (QPoint p)
{
...
int
MarkerSellObject::isGrabSelected (QPoint p)
{
...
void
MarkerSellObject::dialogDone (void *dialog)
{
  MarkerSellDialog *d = (MarkerSellDialog *) dialog;
...
void
MarkerSellObject::sendDrawMessage ()
{
...
void
MarkerSellObject::sendSelectedMessage ()
{
...
void
MarkerSellObject::sendUnselectedMessage ()
{
...
void
MarkerSellObject::sendMovingMessage ()
{
...
void
MarkerSellObject::sendDeleteMessage ()
{
  QDir dir;
  dir.remove(_name);
  _modified = FALSE;
...
int
MarkerSellObject::load (ObjectCommand *oc)
{
  QSettings *settings = (QSettings *) oc->getObject(QString("QSettings"));
  if (! settings)
  {
    qDebug() << "MarkerSellObject::load: invalid QSettings";
    return 0;
  }
...
int
MarkerSellObject::save (ObjectCommand *oc)
{
  QSettings *settings = (QSettings *) oc->getObject(QString("QSettings"));
  if (! settings)
  {
    qDebug() << "MarkerSellObject::save: invalid QSettings";
    return 0;
  }
...
int
MarkerSellObject::update (ObjectCommand *oc)
{
  Object *plot = (Object *) oc->getObject(_plotObject);
  if (! plot)
  {
    qDebug() << "MarkerSellObject::update: invalid plot" << _plotObject;
    return 0;
  }
  ...
  if (! plot->message(&toc))
  {
    qDebug() << "MarkerSellObject::update: message error" << plot->plugin() << toc.command();
    return 0;
  }
...
int
MarkerSellObject::copy (ObjectCommand *oc)
{
  QString key("input");
  Object *input = (Object *) oc->getObject(key);
  if (! input)
  {
    qDebug() << "MarkerSellObject::copy: invalid" << key;
    return 0;
  }
  ...
  {
    qDebug() << "MarkerSellObject::copy: invalid" << input->plugin() << key;
    return 0;
  }
...
int
MarkerSellObject::settings (ObjectCommand *oc)
{
...
int
MarkerSellObject::dialog (ObjectCommand *oc)
{
  MarkerSellDialog *d = new MarkerSellDialog(oc->getObjects(), _name);
