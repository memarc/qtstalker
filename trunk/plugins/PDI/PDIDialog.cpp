...
PDIDialog::PDIDialog (QHash<QString, void *> objects, QString name) : Dialog (0, name)
{
  QStringList tl;
  QDir dir(QDir::homePath());
  tl << dir.absolutePath() << QString("OTA") << QString("PDI") << QString("settings") << QString("dialog");
...
void
PDIDialog::createTab (QHash<QString, void *> l)
{
...
void
PDIDialog::setSettings (QString i, QString hk, QString lk, QString ck, int p)
{
  _input->setInput(i);
...
void
PDIDialog::settings (QString &i, QString &hk, QString &lk, QString &ck, int &p)
{
  i = _input->input();
