...
FontButtonWidget::FontButtonWidget (QWidget *w, QFont f) : QPushButton (w)
{
  _font = f;
...
QFont FontButtonWidget::font ()
{
  return _font;
}

void FontButtonWidget::fontDialog ()
{
...
void FontButtonWidget::fontDialog2 (QFont font)
{
  _font = font;
  setFontButton();
  _changed = TRUE;
...
int FontButtonWidget::isChanged()
{
  return _changed;
}
